...
public class Utenti  implements java.io.Serializable {
    ...
    private it.depositolegale.www.utenti.DatiUtente datiUtente;
    ...
    public Utenti(
           ...
           it.depositolegale.www.utenti.DatiUtente datiUtente) {
     ...
     * @return datiUtente
     */
    public it.depositolegale.www.utenti.DatiUtente getDatiUtente() {
        return datiUtente;
    }
     ...
     * @param datiUtente
     */
    public void setDatiUtente(it.depositolegale.www.utenti.DatiUtente datiUtente) {
        this.datiUtente = datiUtente;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.depositolegale.it/utenti", ">datiUtente"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }

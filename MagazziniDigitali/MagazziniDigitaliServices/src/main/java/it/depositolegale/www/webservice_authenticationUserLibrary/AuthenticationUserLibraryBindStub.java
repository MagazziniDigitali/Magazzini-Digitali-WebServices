/**
 * AuthenticationUserLibraryBindStub.java
 *
...
public class AuthenticationUserLibraryBindStub extends org.apache.axis.client.Stub implements it.depositolegale.www.webservice_authenticationUserLibrary.AuthenticationUserLibraryPortType {
    ...
    public AuthenticationUserLibraryBindStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public AuthenticationUserLibraryBindStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public AuthenticationUserLibraryBindStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://www.depositolegale.it/authenticationUserInput", ">>>rights>rightsDisseminate>rightsDisseminateType");
            cachedSerQNames.add(qName);
            cls = it.depositolegale.www.authenticationUserInput.RightsRightsDisseminateRightsDisseminateType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(enumsf);
            cachedDeserFactories.add(enumdf);

            qName = new javax.xml.namespace.QName("http://www.depositolegale.it/authenticationUserInput", ">>rights>rightsDisseminate");
            cachedSerQNames.add(qName);
            cls = it.depositolegale.www.authenticationUserInput.RightsRightsDisseminate.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://www.depositolegale.it/authenticationUserInput", ">>rights>rightsIdentifier");
            cachedSerQNames.add(qName);
            cls = it.depositolegale.www.authenticationUserInput.RightsRightsIdentifier.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://www.depositolegale.it/authenticationUserInput", ">rights");
            cachedSerQNames.add(qName);
            cls = it.depositolegale.www.authenticationUserInput.Rights.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {authenticationUserLibraryInput});

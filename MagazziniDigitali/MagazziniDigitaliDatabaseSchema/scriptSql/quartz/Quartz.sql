...
--
-- Host: dbservertest.bncf.lan
-- Creato il: Apr 21, 2020 alle 12:01
-- Versione del server: 5.6.17-log
-- Versione PHP: 5.6.40-0+deb8u1
...
--
-- Database: `MagazziniDigitaliSviluppo_Quartz`
--

-- --------------------------------------------------------

--
-- Struttura della tabella `QRTZ_BLOB_TRIGGERS`
--
...
--
-- Struttura della tabella `QRTZ_CALENDARS`
--
...
--
-- Struttura della tabella `QRTZ_CRON_TRIGGERS`
--
...
--
-- Struttura della tabella `QRTZ_FIRED_TRIGGERS`
--
...
--
-- Struttura della tabella `QRTZ_JOB_DETAILS`
--
...
--
-- Struttura della tabella `QRTZ_LOCKS`
--
...
--
-- Struttura della tabella `QRTZ_PAUSED_TRIGGER_GRPS`
--
...
--
-- Struttura della tabella `QRTZ_SCHEDULER_STATE`
--
...
--
-- Struttura della tabella `QRTZ_SIMPLE_TRIGGERS`
--
...
--
-- Struttura della tabella `QRTZ_SIMPROP_TRIGGERS`
--
...
--
-- Struttura della tabella `QRTZ_TRIGGERS`
--
...
--
-- Indici per le tabelle `QRTZ_BLOB_TRIGGERS`
--
...
--
-- Indici per le tabelle `QRTZ_CALENDARS`
--
ALTER TABLE `QRTZ_CALENDARS`
  ADD PRIMARY KEY (`SCHED_NAME`,`CALENDAR_NAME`);

--
-- Indici per le tabelle `QRTZ_CRON_TRIGGERS`
--
ALTER TABLE `QRTZ_CRON_TRIGGERS`
  ADD PRIMARY KEY (`SCHED_NAME`,`TRIGGER_NAME`,`TRIGGER_GROUP`);

--
-- Indici per le tabelle `QRTZ_FIRED_TRIGGERS`
--
...
--
-- Indici per le tabelle `QRTZ_JOB_DETAILS`
--
...
--
-- Indici per le tabelle `QRTZ_LOCKS`
--
ALTER TABLE `QRTZ_LOCKS`
  ADD PRIMARY KEY (`SCHED_NAME`,`LOCK_NAME`);

--
-- Indici per le tabelle `QRTZ_PAUSED_TRIGGER_GRPS`
--
ALTER TABLE `QRTZ_PAUSED_TRIGGER_GRPS`
  ADD PRIMARY KEY (`SCHED_NAME`,`TRIGGER_GROUP`);

--
-- Indici per le tabelle `QRTZ_SCHEDULER_STATE`
--
ALTER TABLE `QRTZ_SCHEDULER_STATE`
  ADD PRIMARY KEY (`SCHED_NAME`,`INSTANCE_NAME`);

--
-- Indici per le tabelle `QRTZ_SIMPLE_TRIGGERS`
--
ALTER TABLE `QRTZ_SIMPLE_TRIGGERS`
  ADD PRIMARY KEY (`SCHED_NAME`,`TRIGGER_NAME`,`TRIGGER_GROUP`);

--
-- Indici per le tabelle `QRTZ_SIMPROP_TRIGGERS`
--
ALTER TABLE `QRTZ_SIMPROP_TRIGGERS`
  ADD PRIMARY KEY (`SCHED_NAME`,`TRIGGER_NAME`,`TRIGGER_GROUP`);

--
-- Indici per le tabelle `QRTZ_TRIGGERS`
--
...
--
-- Limiti per la tabella `QRTZ_BLOB_TRIGGERS`
--
ALTER TABLE `QRTZ_BLOB_TRIGGERS`
...
--
-- Limiti per la tabella `QRTZ_CRON_TRIGGERS`
--
ALTER TABLE `QRTZ_CRON_TRIGGERS`
...
--
-- Limiti per la tabella `QRTZ_SIMPLE_TRIGGERS`
--
ALTER TABLE `QRTZ_SIMPLE_TRIGGERS`
...
--
-- Limiti per la tabella `QRTZ_SIMPROP_TRIGGERS`
--
ALTER TABLE `QRTZ_SIMPROP_TRIGGERS`
